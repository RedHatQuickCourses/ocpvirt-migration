= Migrate VMs from VMware vSphere to Red Hat OpenShift Virtualization
:navtitle: Home
...
// When I press the above link, it doesn't directly guide me to the container fundamentals page. Is this just with me or do we need to update the link?
